"""
Django settings for wispy_paper_41939 project.
...
ROOT_URLCONF = 'wispy_paper_41939.urls'
...
WSGI_APPLICATION = 'wispy_paper_41939.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "wispy_paper_41939 API",
    "DESCRIPTION": "API documentation for wispy_paper_41939 App",
    "VERSION": "v1",
}
